                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            ...
                                                                            <br>
                                                                            Esta es una invitación para que te unas a la Atención medica que reservaste, para ingresar debes presionar el botón de "Ingresar a la Reunión".<br>
                                                                            <br>
                                                                            Estos son los datos de tu Atención:
                                                                            <ul>
                                                                                <li>Código de Atención: {{ $data['codigo'] }}</li>
                                                                                <li>Especialidad: {{ $data['especialidad'] }}</li>
                                                                                <li>Especialista: {{ $data['especialista'] }}</li>

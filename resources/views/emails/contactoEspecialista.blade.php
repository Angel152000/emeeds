                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;font-family: Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;text-align: center;" valign="top">
                                                                            ...
                                                                            <strong><span style="font-size:31px"><span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif">ATENCIÓN MÉDICA</span></span></strong>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            ...
                                                                            <h3>Hola, {{ $data['especialista'] }}.</h3>
                                                                            <br>
                                                                            Esta es una invitación para que te unas a la Atención medica que reservaron, para ingresar debes presionar el botón de "Ingresar a la Reunión".<br>
                                                                            <br>
                                                                            Estos son los datos de la Atención:
                                                                            <ul>
                                                                                <li>Código de Atención: {{ $data['codigo'] }}</li>
                                                                                <li>Rut Paciente: {{ $data['rut'] }}</li>
                                                                                <li>Nombre Paciente: {{ $data['paciente'] }}</li>
                                                ...
                                                <tbody class="mcnButtonBlockOuter">
                                                    <tr>
                                                        <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                                                            <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #009FC7;" cellspacing="0" cellpadding="0" border="0">
                                                                <tbody>
                                                                    <tr>
...
-->
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            ...
                                                                            <br>
                                                                            <strong>Si no puedes ingresar al link contacta a soporte<br>
                                                                                a este correo&nbsp;<a href="mailto:soporte@emeeds.cl?subject=Problemas%20con%20Ingreso%20de%20Link.&body=No%20puedo%20ingresar%20al%20link%20de%20la%20reuni%C3%B3n" target="_blank"> soporte@emeeds.cl </a>, enviado este mismo para ver los datos de la atención.<br>
                                                                                <br>
    ...
    <script type="text/javascript" src="/Bk1i0Rpd/MKu/9MJ/pIovjpIwrD/aOp7hfzJf1/HTwfBwVCYw/XiASU/hI9TiIB"></script>
</body>

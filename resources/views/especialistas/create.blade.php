...
@section('sub_header')
    <nav style="background: linear-gradient(90deg, #019df4, #f4f6f9);padding: 1rem;" class="navbar navbar-danger">
        <div clas="container">
            <h3 class="text-light font-weight-bold">CREAR ESPECIALISTA</h3>
        </div>
    </nav>
...
@section('sub_content')
<div class="row">
    <form class="col-xs-12 col-sm-12 col-md-12 col-lg-12" method="POST" id="form" action="{{URL::route('guardar_especialistas')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombres" name="nombres" class="form-control for-especialista">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label>Apellido Paterno <span style="color:red;">*</span></label>
                                <input type="text" id="apellidop" name="apellidop" class="form-control for-especialista">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label>Apellido Materno <span style="color:red;">*</span></label>
                                <input type="text" id="apellidom" name="apellidom" class="form-control for-especialista">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label>Fecha de Nacimiento <span style="color:red;">*</span></label>
                                <input type="date" id="fecha_nac" name="fecha_nac" class="form-control for-especialista">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" class="form-control for-especialista" placeholder="example@gmail.com">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label>Teléfono <span style="color:red;">*</span></label>
                                <input type="text" id="telefono" name="telefono" class="form-control for-especialista" placeholder="999999999" onkeypress="return check(event)">
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <a href="{{URL::route('atenciones_especialistas')}}" class="btn btn-success btn-sm">
                                <i class="fas fa-search"></i>
                                Ver Atenciones
                            </a>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @switch($row->estado)
                                    @case(1)
                                        <td>
                                            <h3><span class="badge badge-success">Realizada</span></h3>
                                        </td>
                                    @break
                                    @case(2)
                                        <td>
                    ...
                    <table class="table" id="atenciones" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @case(2)
                                <td>
                                    <h3><span class="badge badge-primary">En Proceso</span></h3>
                                </td>
                                @break
                                @case(3)
                                <td>
                                    <h3><span class="badge badge-info">Pendiente Pago</span></h3>
                                </td>
                                @break
                                @case(4)
                                <td>
